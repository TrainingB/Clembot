...
class Column:
    ...
    def is_null_(self):
        return SQLComparison(
            SQLOperator.is_null_(), self.aggregate, self.full_name)
    ...
    async def getjson(self, **filters):
        return await self.table.getjson(columns=self.name, **filters)
