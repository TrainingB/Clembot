...
def core_table_sqls():
    ...
    sql_dict = {
        'gym_master' : (
        "CREATE TABLE public.gym_master ("
        "region_code_key text, "
        "city_state_key text, "
        "gym_code_key text,"
        "original_gym_name text, "
        "gym_name text, "
        "latitude text ,"
        "longitude text ,"
        "gym_location_city text, "
        "gym_location_state text ,"
        "word_1 text ,"
        "word_2 text ,"
        "word_3 text, "
        "gmap_url ,"
        ...
        'sample_test' : ( "create table sample_test("
                          "id serial, "
                          "key text, "
                          "value text, "
                          "notes text "
