    ...
    async def auto_draft_for_current_player(self, ctx, draft):
        ...
        while True:
            ...
            try:
                ...
                await Utilities.message(ctx.channel, f"**[{draft.current_drafted_slots}/{draft.total_drafted_slots}]** Player <@{draft.current_player}> has drafted **{pokemon}** successfully. **[Auto Drafted]**")
