...
class BingoCardManager:
    ...
    async def find_bingo_card(self, guild_id, user_id, event):
        ...
        try:
            ...
            bingo_card_table = self.dbi.table('bingo_card')

            bingo_card_query = bingo_card_table.query().select().where(guild_id=guild_id, user_id=user_id, event=event)
    ...
    async def save_bingo_card(self, guild_id, user_id, event, bingo_card, bingo_card_url, generated_at):
        ...
        try:
            ...
            table = self.dbi.table('bingo_card')
            ...
            if existing_bingo_card:
                ...
                insert_query = table.insert(**bingo_card_record)
