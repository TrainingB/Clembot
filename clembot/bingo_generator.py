...
def generate_card():
    ...
    cell_1_value = "CP : {0}".format(cell_1_range, cell_1_json['Stardust'])


    cell_2_iv = randint(10,15)
    cell_2_attribute = stats[randint(0,2)]
    cell_2_value = "{0} stat = {1}".format(cell_2_attribute,cell_2_iv)
    ...
    cell_3_value = "CP : {0}".format(cell_3_range, cell_3_json['Stardust'])
    ...
    cell_4_value = "CP : {0}".format(cell_4_range, cell_4_json['Stardust'])
    ...
    cell_6_value = "CP : {0}".format(cell_6_range, cell_6_json['Stardust'])
    ...
    cell_7_value = "CP : {0}".format(cell_7_range, cell_7_json['Stardust'])

    cell_8_iv = randint(0,15) + randint(0,15) + randint(0,15)
    cell_8_attribute = round(cell_8_iv * 100 / 45 , 1 )
    cell_8_value = "Overall IV = {0}".format(cell_8_attribute)
    ...
    cell_9_value = "CP : {0}".format(cell_9_range, cell_9_json['Stardust'])
